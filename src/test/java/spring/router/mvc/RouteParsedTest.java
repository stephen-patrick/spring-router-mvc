...
public class RouteParsedTest {
	...
	public void match_emptyRoute() {
		...
		RouteMatchResult matchResult = parsedRoute.match("/");
	...
	public void match_literalRoute() {
		...
		RouteMatchResult matchResult = parsedRoute.match("part1/part2/part3");
	...
	public void match_compositeRoute() {
		...
		RouteParsed parsedRoute = new RouteParsed(pathSegments);
		RouteMatchResult matchResult = parsedRoute
	...
	protected void assertRouteParameters(RouteMatchResult result,
